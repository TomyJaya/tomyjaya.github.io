...
![https](https://i.stack.imgur.com/SGyYa.png){:height="200px" width="300px"}
...
![certificate_vs_public_key.png](/img/certificate_vs_public_key.png){:height="190px" width="300px"}
...
![https](https://docs.oracle.com/cd/E19798-01/821-1841/images/security-sslBMAWithCertificates.gif){:height="300px" width="300px"}

**Source**: [Oracle](https://docs.oracle.com/cd/E19798-01/821-1841/bncbt/index.html)
...
![keystore_vs_key.png](/img/keystore_vs_key.png){:height="300px" width="300px"}

## Keytore Types: `jks` vs `p12` 

JKS was a popular Java keystore format until Java 8. Nowadays, it's deprecated. `.p12`/ `.pfx` (aka pkcs12) is the language agnostic alternative. PKCS12 file usually contains a bundled pair of private key and its corresponding certificate (incl. public key). But in theory, it can hold more than that.  
...
![connection_not_secure.png](/img/connection_not_secure.png){:height="300px" width="300px"}
...
Let me know if you have other HTTPS-related concepts you found useful, and I would be glad to add it to this list. And as always, I'd really appreciate your feedback especially if you found some things which are inaccurate. 
